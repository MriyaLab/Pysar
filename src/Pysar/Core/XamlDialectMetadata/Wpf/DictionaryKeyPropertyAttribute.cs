...
/// <summary>
/// Exposes dictionary-key metadata to XAML language services that recognize the
/// standard WPF attribute name.
/// </summary>
/// <remarks>
...
public sealed class DictionaryKeyPropertyAttribute(string name) : Attribute
{
