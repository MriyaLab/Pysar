...
/// </summary>
/// <remarks>
///     WebAssembly has no background thread to hand this to, so <see cref="TaskRunScheduler"/> would
///     run the work inline and freeze the page for as long as a cell takes. Yielding first lets the
///     browser paint the cells that have already arrived and process scrolling before the next one
///     starts.
/// </remarks>
