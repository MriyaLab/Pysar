...
public class MasterDetailReportFluentApi
{
    ...
    private static StackPanel BuildDocumentHeader(
        ...
        new StackPanel()
            ...
            .AddElement(new Grid()
                ...
                .AddElement(Label("Annual Report", 22, FontStyle.Bold, darkGray), 0, 0)
                .AddElement(Label(data.Company, 14), 1, 0)
                .AddElement(Label(data.YearLabel, 14)
                    .WithHorizontalAlignment(Alignment.End)
                    .WithVerticalAlignment(Alignment.Center), 0, 1, 2, 1))
            .AddElement(new Grid()
                .WithSize(SizeLength.Fill, SizeLength.Auto)
                .WithMargin(0, 15, 0, 0)
                .WithPadding(15)
    ...
    private static Grid BuildMonthHeader(
        ...
        new Grid()
            ...
            .AddElement(Label(month.Name, 9, FontStyle.Bold, darkGray)
                .WithVerticalAlignment(Alignment.Center), 0, 0)
    ...
    {
        var label = MoneyLabel(value, size, style);
